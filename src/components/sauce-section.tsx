        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="relative flex items-center mb-2">
              ...
              <p className="relative bg-background px-4 text-primary tracking-wide text-sm font-medium">The Secret</p>
            </div>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif text-primary mb-2">Homemade Premium</h2>
            <p className="text-accent text-3xl font-serif mb-6">Sauces</p>
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
              What makes our burgers unforgettable? Our handcrafted sauces, made fresh in-house every single day.
              From our creamy Dutch Burger Sauce to the fiery Moroccan Harissa Mayo - each recipe is a closely
